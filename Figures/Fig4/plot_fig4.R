...
dat<-read.table("./act_nmd_data.txt",header=T)
...
# MVA
dat<-read.table("./combined_CPI_dat_all_final.txt",header=T)
summary(glm(benefit~TMB+nmd_escape+study,data=dat,family=binomial(link='logit')))
